...
public class PageUtil {
     ...
     * @param page         현재 페이지 번호 (요청 파리미터)
     * @param display      한 페이지에 표현할 게시글 최대 개수
     * @param pagePerBlock 페이징 바에 표현할 페이지 최대 개수
     * @return  totalCount, page, display, pagePerBlock, totalPage, beginPage, endPage
     */
