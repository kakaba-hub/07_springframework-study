...
<body>
  ...
  <form action="${contextPath}/menu/modify.do" method="post">
    ...
    가격 : <input type="number" name="menuPrice" value="${menu.menuPrice}"> <br>
    카테고리번호 : <input type="text" name="categoryCode" value="${menu.categoryCode}"> <br>
    판매여부 :
