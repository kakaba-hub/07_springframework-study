...
<body>
  ...
  <h3>3. 요청파리미터(request param) 처리 연습</h3>

  <a href="${contextPath}/member/detail.do?no=1">1번 회원 상세조회</a>
  <br><br>
  ...
  <!--
    ...
    1. REST 방식 개발
      ...
      2) 백엔드에서 요청에 따라 페이지 forwarding 또는 redirect가 아닌 요청에 필요한 데이터(자원, 리소스)만을 응답하는 방식
