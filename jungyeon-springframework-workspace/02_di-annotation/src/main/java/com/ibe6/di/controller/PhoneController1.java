package com.ibe6.di.controller;

import com.ibe6.di.dto.Phone;
...
public class PhoneController1 {
    ...
    public void setA(Phone abc){ // 해당 메소드가 실행될 때 매개변수 DI 발생됨
        this.a = abc;
    }
    ...
    // 오류를 유발시킴 (@Inject와 동일)
    // ==> 필드명을 주입받고자 하는 빈의 이름(id)으로 작성 => 이름으로 빈을 탐색해서 주입해줌
