...
import com.jjanggu.webmvc.service.NoticeService;
import com.jjanggu.webmvc.service.NoticeServiceImpl;
...
public class NoticeController {
    ...
    public String noticeModify(NoticeDto n, RedirectAttributes rd) {
        ...
        // * 유의사항 : RedirectAttributes에 반드시 flashAttributes로 담아야됨!
        //              그냥 attributes로 담으면 Model(requestScope)에 담은거랑 동일한 맥락
    }
}
